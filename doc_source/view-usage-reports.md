# AWS Usage Reports<a name="view-usage-reports"></a>

**Important**  
The AWS Usage Reports will be unavailable at a later date\. We strongly recommend that you use the [AWS Cost and Usage Report](billing-reports-costusage.md) instead\.
